...
session.set_dont_like(['male', 'gay', 'drugs', '420', 'sex', 'porn', 'naked', 'boy', 'body', 'model'])
session.set_do_follow(enabled=True, percentage=20, times=1)
#session.unfollow_users(amount=100, onlyInstapyFollowed=True, onlyInstapyMethod = 'FIFO')
